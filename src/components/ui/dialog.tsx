  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          fullscreen
            ? "fixed inset-0 z-[100] grid h-dvh w-screen max-w-none translate-x-0 translate-y-0 gap-0 rounded-none bg-popover p-0 text-sm text-popover-foreground outline-none"
